...
export default {
  ...
  data() {
    return {
      ...
      currentIndex: 0,
      transitioning: true // Initially set to true to hide the lines
    };
  },
  methods: {
    nextSlide() {
...
.text-container {
  position: relative;
  padding: 50px 0 0 50px; /* Adjust padding */
}
...
.text-container::after {
  ...
  border: 2px solid #C8B560; /* Add border with 4px thickness */
}
...
.text-container::before {
  ...
  left: -5px;
  width: 2px;
  height: 100vh; /* Extend the line to the full height of the page */
